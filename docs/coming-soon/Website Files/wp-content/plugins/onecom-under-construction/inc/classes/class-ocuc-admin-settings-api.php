...
class OCUC_Admin_Settings_API {
	...
	public function callback_submit() {
		// Regular save button
		submit_button( __( 'Save', 'onecom-uc' ), 'uc-submit-button oc-uc-btn oc-regular-submit' );

		// Bottom fixed button for mobile
		echo '<div class="oc_sticky_footer">' .
			get_submit_button( __( 'Save', 'onecom-uc' ), 'uc-submit-button oc-uc-btn', 'submit', false ) .
		'</div>';

		// Alternate floating save button for desktop
		submit_button( __( 'Save', 'onecom-uc' ), 'uc-submit-button oc-uc-btn oc-uc-float-btn' );
	}
