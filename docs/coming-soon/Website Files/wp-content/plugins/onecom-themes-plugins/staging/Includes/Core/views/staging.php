						...
						<div class="oc-column oc-right-column align-center-btn">
							<div class="one-card-action-old">
								...
								<div class="wrap-rgh-btn align-center">
									<button id="deploy_to_live" class="one-button btn button_1 one-button-copy-to-live" data-dialog-id="staging-copy-confirmation" data-title="<?php _e( 'Are you sure?', 'onecom-wp' ); ?>" data-width="500" data-height="320" data-live-id="<?php echo $existing_live->directoryName; ?>"><?php _e( 'Copy staging to live', 'onecom-wp' ); ?></button>
								</div>
								<div class="wrap-rgh-btn align-center">
									<a href="<?php echo onecom_generic_locale_link( $request = 'staging_guide', get_locale() ); ?>" target="_blank" class="help_link"><img src="<?php echo ONECOM_WP_URL . 'assets/images/need-help.svg'; ?>" alt="Need help" class="action-rht-img" /><span><?php _e( 'Need help?', 'onecom-wp' ); ?></span></a>
								</div>
								<?php } ?>
							</div>
						</div>
