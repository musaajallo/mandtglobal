					...
					<?php endif; ?>
						<div class="one-card-staging-create-info">
							...
							<div class="oc-column oc-right-column">
								...
								<?php
								$create_btn = '<div class="wrap-rgh-btn align-center"><input type="button" value="' . __( 'Create staging site', 'onecom-wp' ) . '" class="one-button btn button_1 one-button-create-staging no-left-margin no-right-margin" /></div>';
								echo $create_btn;
								?>
								<div class="wrap-rgh-btn align-center"><a href="<?php echo onecom_generic_locale_link( 'staging_guide', get_locale() ); ?>" class="help_link" target="_blank"><img src="<?php echo ONECOM_WP_URL . 'assets/images/need-help.svg'; ?>" alt="Need help" class="action-rht-img" /><span><?php _e( 'Need help?', 'onecom-wp' ); ?></span></a></div>
							</div>
							</div>
						</div>
				</div>
