...
class OnecomCheckUpdates extends OnecomHealthMonitor {
	...
	public function php_updates() {
		...
		if ( $php_updates_available ) {
			...
			$desc   = sprintf( __( 'You are running an outdated version of PHP. We recommend using the latest version of PHP. %sHow do I update PHP for my WordPress site?%s', 'onecom-wp' ) );
