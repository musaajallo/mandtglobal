...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'MandT Global')); ?></title>
    ...
    <body class="bg-gray-50 font-sans antialiased">
        <div class="flex min-h-screen flex-col items-center justify-center">
            <h1 class="text-4xl font-bold text-gray-900"><?php echo e(config('app.name', 'MandT Global')); ?></h1>
...
<?php /**PATH /home/musaajallo/software_development/projects/web_apps/mandtglobal/resources/views/welcome.blade.php ENDPATH**/ ?>